  ...
  return (
    ...
    >
      <div className="flex ">
        ...
        <div className="w-1/2 h-[79vh]">
          ...
          <div className=" font-['Neue_Montreal']">
            <div className="relative top-[3vw]  w-[100px] ">
              <span className="m-3 ml-0  ">S:</span>
            ...
            <div className="relative top-5 w-[400px] ">
              <span className="m-3 ml-0 ">E:</span>
              <ul className=" decoration-none m-5 ml-0 ">
                <li className="underline  ">
                  {" "}
      ...
      <div className="flex p-8 pb-2">
        ...
        <div className="w-1/2 flex justify-between pt-3">
          <p className="text-[#fffcfc91]">© ochi design 2024. Legal Terms</p>
          <p className="text-[#fffcfc91] px-4">Website by Obys</p>
        </div>
      </div>
    </div>
  );
